 ...
 $('.option').click(function()
 {
  if(questionLock==false)
  {
	...
	function displayFinalSlide()
	{
		...
		$(stage).append('<div class="questionText">! סיימת את הבחינה<br><br>סה"כ שאלות : '+numberOfQuestions+'<br>תשובות נכונות : '+rightAnswer+ '<br>תשובות שגויות: ' + wrongAsnwer + '</div>'); //score
